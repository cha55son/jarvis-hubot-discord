...
jarvis is a chat bot built on the [Hubot][hubot] framework.
...
* Copy `config.sh.template` to `config.sh` and add environment variables as needed.
* Install redis if you haven't already `brew install redis`.
